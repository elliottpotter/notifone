...
class HostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create host" do
    assert_difference('Host.count') do
      post hosts_url, params: { host: { active: @host.active, domain: @host.domain, name: @host.name, tier: @host.tier } }
    end
  ...
  test "should update host" do
    patch host_url(@host), params: { host: { active: @host.active, domain: @host.domain, name: @host.name, tier: @host.tier } }
