...
class AdvertisersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertiser" do
    assert_difference('Advertiser.count') do
      post advertisers_url, params: { advertiser: { email: @advertiser.email, name: @advertiser.name, phone_number: @advertiser.phone_number, stripe_customer_id: @advertiser.stripe_customer_id } }
    end
  ...
  test "should update advertiser" do
    patch advertiser_url(@advertiser), params: { advertiser: { email: @advertiser.email, name: @advertiser.name, phone_number: @advertiser.phone_number, stripe_customer_id: @advertiser.stripe_customer_id } }
